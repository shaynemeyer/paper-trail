...
- Only allow ShadCN components in the components/ui folder, DO NOT WRITE non ShadCN components there.
- If you need to adapt function for say the ShadCN Button, make copy of the button code and create a new components/{domain}/custom-button.tsx. "custom" is just an example use a name that makes sense for the components purpose. 
